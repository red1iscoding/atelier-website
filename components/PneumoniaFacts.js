...
export default function PneumoniaFacts() {
  return (
    <div className="bg-red-600 py-16 px-4"> {/* Set background color to red */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg h-full flex flex-col justify-between transform hover:scale-105 transition-all duration-300 hover:shadow-2xl">
          <div className="flex justify-center items-center">
            <FaHeartbeat className="text-red-500 text-4xl mb-4" /> {/* Icon */}
          </div>
          <h3 className="text-2xl font-semibold text-red-500">What is Pneumonia?</h3>
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg h-full flex flex-col justify-between transform hover:scale-105 transition-all duration-300 hover:shadow-2xl">
          <div className="flex justify-center items-center">
            <FaChartLine className="text-red-500 text-4xl mb-4" /> {/* Icon */}
          </div>
          <h3 className="text-2xl font-semibold text-red-500">Why Early Diagnosis Matters</h3>
          <p className="text-lg mt-4 text-gray-600 flex-grow">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg h-full flex flex-col justify-between transform hover:scale-105 transition-all duration-300 hover:shadow-2xl">
          <div className="flex justify-center items-center">
            <FaRobot className="text-red-500 text-4xl mb-4" /> {/* Icon */}
          </div>
          <h3 className="text-2xl font-semibold text-red-500">AI-Powered Diagnosis</h3>
          <p className="text-lg mt-4 text-gray-600 flex-grow">
